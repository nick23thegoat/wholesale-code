...
low/mid/high rehab band, computes MAO and a recommended offer below MAO, scores
the deal 0–100, and returns 🔥 GO / 🟠 NEGOTIATE / 🟡 NEED MORE DATA / ❌ PASS
with every risk flag and data gap spelled out.
